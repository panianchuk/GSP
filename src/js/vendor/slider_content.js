export const services_content = [
  {
    ...
    img_mob: "./img/services/1-mob.png",
    img_desk: "./img/services/1-desk.png",
  },
  {
    id: 2,
    heading: "Corporate Security",
    text: "Corporate Security involves protecting a company's physical assets, employees, information and operations from various threats and risks.  This includes protection against theft, vandalism, espionage, workplace violence and other potential security issues.",
    img_mob: "./img/services/2-mob.png",
    img_desk: "./img/services/2-desk.png",
  },
  {
    id: 3,
    ...
    img_mob: "./img/services/3-mob.png",
    img_desk: "./img/services/3-desk.png",
  },
  {
    id: 4,
    ...
    img_mob: "./img/services/4-mob.png",
    img_desk: "./img/services/4-desk.png",
  },
  {
    id: 5,
    ...
    img_mob: "./img/services/5-mob.png",
    img_desk: "./img/services/5-desk.png",
  },
];
